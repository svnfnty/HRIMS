...
<form action="" id="application-form" class="h-100">
       ...
       <fieldset class="set-item flex-grow-1 h-100 overflow-auto mb-1" data-target="basic_info">
            <div class="row mx-0">
                <div class="col-md-6">
                    ...
                    <input type="text" name="lname" id="lname" class="form-control form-control-sm rounded-0" placeholder="Enter Last Name" required>
                    
                    <label for="fname" class="control-label">First Name</label>
                    <input type="text" name="fname" id="fname" class="form-control form-control-sm rounded-0" placeholder="Enter First Name" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="mname" id="mname" class="form-control form-control-sm rounded-0" placeholder="Enter Middle Name" required>
                    
                    <label for="extname" class="control-label">Extension Name</label>
                    <input type="text" name="extname" id="extname" class="form-control form-control-sm rounded-0" placeholder="Enter Ext Name (if any)">
                    <div class="form-group">
