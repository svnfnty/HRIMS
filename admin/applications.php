...
<div class="card">
    ...
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php 
                $sql = "SELECT a.*,d.name as dept,dd.name as desg FROM `applicant_list` a inner join vacancy_list v on a.vacancy_id = v.vacancy_id inner join `designation_list` dd on v.designation_id = dd.designation_id inner join `department_list` d on dd.department_id = d.department_id order by UNIX_TIMESTAMP(a.date_created) asc";
                $qry = $conn->query($sql);
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="py-0 px-1">
                        <?php echo $row['fname']; ?>
                        <?php echo !empty($row['mname']) ? $row['mname'] . ' ' : ''; ?>
                        <?php echo $row['lname']; ?>
                    </td>
