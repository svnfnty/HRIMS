...
<div class="card">
    ...
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php 
                $sql = "SELECT v.*, d.name as dept, dd.name as desg 
                FROM `vacancy_list` v
                INNER JOIN `designation_list` dd ON v.designation_id = dd.designation_id
                INNER JOIN `department_list` d ON dd.department_id = d.department_id
                ORDER BY UNIX_TIMESTAMP(v.date_created) ASC";
