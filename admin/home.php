<h3>Welcome to Human Resource Integrated Management System</h3>
<hr>
<div class="col-12">
                    ...
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $vacancy = $conn->query("SELECT count(vacancy_id) as `count` FROM `vacancy_list` ")->fetch_assoc()['count'];
                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $applicants = $conn->query("SELECT count(applicant_id) as `count` FROM `applicant_list` where status = 1 ")->fetch_assoc()['count'];
                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $applicants = $conn->query("SELECT count(applicant_id) as `count` FROM `applicant_list` where status = 2 ")->fetch_assoc()['count'];
                                echo $applicants > 0 ? number_format($applicants) : 0 ;
                                ?>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $applicants = $conn->query("SELECT count(applicant_id) as `count` FROM `applicant_list` where status = 3 ")->fetch_assoc()['count'];
                                echo $applicants > 0 ? number_format($applicants) : 0 ;
                                ?>
                            </div>
                        </div>
