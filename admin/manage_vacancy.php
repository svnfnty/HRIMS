                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="designation_id" id="designation_id" class="form-select form-select-sm rounded-0" required>
                            ...
                            <?php
                            $designation = $conn->query("SELECT dd.*,(d.name || '-' ||dd.`name`) as info_name FROM designation_list dd inner join department_list d on dd.department_id = d.department_id order by `name` asc");
