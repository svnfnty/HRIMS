...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | HRIMS</title>
    ...
    <style>
       ...
       .custom-bg-gradient {
            background: linear-gradient(135deg, #6a11cb 0%, #2575fc 100%); /* Gradient from DodgerBlue to SteelBlue */
            color: white; /* Ensures text is readable */
        }

        .custom-bg-gradient .navbar-nav .nav-link {
            color: white; /* Text color for nav links */
            font-weight: bold; /* Adds some emphasis to the text */
        }

        .custom-bg-gradient .navbar-nav .nav-link:hover {
            color: #ADD8E6; /* LightBlue color for a subtle hover effect */
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark custom-bg-gradient" id="topNavBar" style="z-index:2">
        <div class="container">
